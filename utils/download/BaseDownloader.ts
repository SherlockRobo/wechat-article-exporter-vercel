...
const INTERNAL_PROXY = '/api/web/misc/proxy';
...
export class BaseDownloader {
  ...
  constructor(urls: string[], options: DownloadOptions = {}) {
    ...
    const proxies = [INTERNAL_PROXY, ...privateProxies];
    ...
    this.proxyManager = new ProxyManager(uniqueProxies, this.options.cooldownPeriod, this.options.maxFailures);
  }
